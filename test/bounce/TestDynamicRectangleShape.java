...
public class TestDynamicRectangleShape {
    ...
    public void testShapeMoveWithBounceOffRight() {
        DynamicRectangleShape shape = new DynamicRectangleShape(100, 20, 12, 15, 25, 35, Color.blue, Color.PINK);
        shape.paint(painter);
        shape.move(135, 10000);
        shape.paint(painter);
        shape.move(135, 10000);
        shape.paint(painter);
        assertEquals("(dynamicrectangle null)(dynamicrectangle null)(rectangle 100,20,25,35)(dynamicrectangle null)(dynamicrectangle java.awt.Color[r=255,g=175,b=175])(rectangle 110,35,25,35)(dynamicrectangle null)(dynamicrectangle java.awt.Color[r=255,g=175,b=175])(rectangle 98,50,25,35)(dynamicrectangle null)" , painter.toString());
    }


    @Test
    public void testShapeMoveWithBounceOffLeft() {
        DynamicRectangleShape shape = new DynamicRectangleShape(10, 20, -12, 15,25, 35, Color.blue, Color.PINK);
        shape.paint(painter);
    ...
    public void testShapeMoveWithBounceOffBottom() {
        DynamicRectangleShape shape = new DynamicRectangleShape(90, 90, 0, 15,25, 35, Color.blue, Color.PINK);
        shape.paint(painter);
        shape.move(135, 135);
        shape.paint(painter);
        shape.move(135, 135);
    ...
    public void testShapeMoveWithBounceOffTop() {
        DynamicRectangleShape shape = new DynamicRectangleShape(50, 90, 0, 15,25, 35, Color.blue, Color.PINK);
        shape.paint(painter);
        shape.move(125, 135);
        shape.paint(painter);
        shape.move(125, 135);
    ...
    public void testShapeMoveWithBounceOffBottomAndRight() {
        DynamicRectangleShape shape = new DynamicRectangleShape(90, 90, 12, 15,25, 35, Color.blue, Color.PINK);
        shape.paint(painter);
        shape.move(125, 135);
        shape.paint(painter);
        shape.move(125, 135);
        shape.paint(painter);
        assertEquals("(dynamicrectangle null)(dynamicrectangle null)(rectangle 90,90,25,35)(dynamicrectangle null)(dynamicrectangle java.awt.Color[r=255,g=175,b=175])(rectangle 100,100,25,35)(dynamicrectangle null)(dynamicrectangle java.awt.Color[r=255,g=175,b=175])(rectangle 88,85,25,35)(dynamicrectangle null)", painter.toString());
    }
    @Test
    public void testShapeMoveWithBounceOffTopAndLeft() {
        DynamicRectangleShape shape = new DynamicRectangleShape(10, 90, -12, 15,25, 35, Color.blue, Color.PINK);
        shape.paint(painter);
        shape.move(125, 135);
        shape.paint(painter);
        shape.move(125, 135);
